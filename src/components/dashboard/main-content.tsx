...
// Maps Lucide icon names (as stored in the DB) to components
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {collections.map((col) => (
            <Card
              key={col.id}
              className="border-border border-l-[3px] bg-card hover:bg-accent/40 transition-colors cursor-pointer"
            ...
            >
              <CardContent className="p-4">
                <div className="flex items-start justify-between gap-2 mb-1">
                  ...
                  <button className="shrink-0 text-muted-foreground hover:text-foreground transition-colors -mr-1">
